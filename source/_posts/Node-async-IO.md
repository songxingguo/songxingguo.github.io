...
![不同的I/O类型及其对应的开销I/O类型](http://p9myzkds7.bkt.clouddn.com/Node-async-IO/%E4%B8%8D%E5%90%8C%E7%9A%84IO%E7%B1%BB%E5%9E%8B%E5%8F%8A%E5%85%B6%E5%AF%B9%E5%BA%94%E5%BC%80%E9%94%80.png)
...
![异步I/O的调用示意图](http://p9myzkds7.bkt.clouddn.com/Node-async-IO/%E5%BC%82%E6%AD%A5IO%E7%9A%84%E8%B0%83%E7%94%A8%E7%A4%BA%E6%84%8F%E5%9B%BE.jpg)
...
![调用阻塞I/O的过程](http://p9myzkds7.bkt.clouddn.com/Node-async-IO/%E8%B0%83%E7%94%A8%E9%98%BB%E5%A1%9EIO%E7%9A%84%E8%BF%87%E7%A8%8B.jpg)
...
![调用非阻塞I/O的过程](http://p9myzkds7.bkt.clouddn.com/Node-async-IO/%E8%B0%83%E7%94%A8%E9%9D%9E%E9%98%BB%E5%A1%9EIO%E7%9A%84%E8%BF%87%E7%A8%8B.jpg)
...
- read。它是最原始、性能最低的一种，通过重复调用来检查I/O的状态来完成完整数据的读取。在得到最终数据前，CPU一直耗用在等待上。下图为通过read进行轮询的示意图。
  ...
  ![通过read进行轮询的示意图](http://p9myzkds7.bkt.clouddn.com/Node-async-IO/%E9%80%9A%E8%BF%87read%E8%BF%9B%E8%A1%8C%E8%BD%AE%E8%AF%A2%E7%9A%84%E7%A4%BA%E6%84%8F%E5%9B%BE.jpg)

- select。它是在read的基础上改进的一种方案，通过对文件描述符上的事件状态来进行判断。下图为通过select进行轮询的示意图。

  ![通过select进行轮询的示意图](http://p9myzkds7.bkt.clouddn.com/Node-async-IO/%E9%80%9A%E8%BF%87select%E8%BF%9B%E8%A1%8C%E8%BD%AE%E8%AF%A2%E7%9A%84%E7%A4%BA%E6%84%8F%E5%9B%BE.jpg)
...
- poll。该方案较select有所改进，采用链表的方式避免数组长度的限制，其次它能避免不需要的检查。但是当文件描述符较多的时候，它的性能还是十分低下的。下图为通过poll实现轮询的示意图，它与select相似，但性能限制有所改善。
  ...
  ![通过poll实现轮询的示意图](http://p9myzkds7.bkt.clouddn.com/Node-async-IO/%E9%80%9A%E8%BF%87poll%E5%AE%9E%E7%8E%B0%E8%BD%AE%E8%AF%A2%E7%9A%84%E7%A4%BA%E6%84%8F%E5%9B%BE.jpg)
...
- epoll。该方案是Linux下效率最高的I/O事件通知机制，在进入轮询的时候如果没有检查到I/O事件，将会进行休眠，直到事件发生将它唤醒。它是真实利用了事件通知、执行回调的方式，而不是遍历查询，所以不会浪费CPU，执行效率较高。下图为通过epoll方式实现轮询的示意图。
  ...
  ![通过epoll方式实现轮询的示意图](http://p9myzkds7.bkt.clouddn.com/Node-async-IO/%E9%80%9A%E8%BF%87epoll%E6%96%B9%E5%BC%8F%E5%AE%9E%E7%8E%B0%E8%BD%AE%E8%AF%A2%E7%9A%84%E7%A4%BA%E6%84%8F%E5%9B%BE.jpg)
...
![理想中的异步I/O示意图](http://p9myzkds7.bkt.clouddn.com/Node-async-IO/%E7%90%86%E6%83%B3%E4%B8%AD%E7%9A%84%E5%BC%82%E6%AD%A5IO%E7%A4%BA%E6%84%8F%E5%9B%BE.jpg)
...
![异步I/O](http://p9myzkds7.bkt.clouddn.com/Node-async-IO/%E5%BC%82%E6%AD%A5IO.jpg)
...
![基于libuv的框架示意图](http://p9myzkds7.bkt.clouddn.com/Node-async-IO/%E5%9F%BA%E4%BA%8Elibuv%E7%9A%84%E6%A1%86%E6%9E%B6%E7%A4%BA%E6%84%8F%E5%9B%BE.jpg)
...
![Tick流程图](http://p9myzkds7.bkt.clouddn.com/Node-async-IO/Tick%E6%B5%81%E7%A8%8B%E5%9B%BE.jpg)
...
![调用示意图](http://p9myzkds7.bkt.clouddn.com/Node-async-IO/%E8%B0%83%E7%94%A8%E7%A4%BA%E6%84%8F%E5%9B%BE.jpg)
...
![整个异步I/O的流程](http://p9myzkds7.bkt.clouddn.com/Node-async-IO/%E6%95%B4%E4%B8%AA%E5%BC%82%E6%AD%A5IO%E7%9A%84%E6%B5%81%E7%A8%8B.jpg)
...
![setTimeout()的行为](http://p9myzkds7.bkt.clouddn.com/Node-async-IO/setTimeout%28%29%E7%9A%84%E8%A1%8C%E4%B8%BA.jpg)
...
![Node构建Web服务器](http://p9myzkds7.bkt.clouddn.com/Node-async-IO/Node%E6%9E%84%E5%BB%BAWeb%E6%9C%8D%E5%8A%A1%E5%99%A8.jpg)
