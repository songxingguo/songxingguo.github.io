...
<html>
 ...
 <body>
   //Zone.js 是一个提供变更检测的库 
  <script src="//unpkg.com/zone.js@0.8.4"></script> //TypeScript编译器在浏览器中将源代码编译成JavaScript 
  <script src="//unpkg.com/typescript@2.0.0"></script> //SystemJS将应用程序代码动态加载到浏览器中。 
  ...
  <hello-world></hello-world> 表示main.ts中实现的组件。 
...
注解过的HelloWorldCompoent类表示组件class HelloWorldComponent {
